...
/**
 * The design result. A real-feeling plan built from catalog products: a single
 * budget-fit design (no spending tiers to choose), kept furniture, a per-item
 * list with reasons + replace/remove, an accessible budget meter, and the
 * flagship "Add entire design to cart" which reuses the Phase 03 cart.
 */
